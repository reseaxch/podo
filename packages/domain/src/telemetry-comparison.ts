...
interface TelemetryComparisonOptions {
  service: string
  metricName: string
  metricUnit: string
...
interface TelemetryWindowMeasurements {
  eventCount: number
...
interface TelemetryComparisonReport {
...
function parseTelemetryInstant(value: unknown): number | null {
